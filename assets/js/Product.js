...
// xhr.open('GET', '/assets/api/ProductData.php');
// xhr.send();
//
...
//                 let product = document.createElement('div'); // create new product div
...
//                             </div>
//                         </div>
// <!--                        <div class="info_booking_add_img hide">-->
// <!--                            <div class="add_img_block">-->
// <!--                                <img src="./img/person.png" alt="First_img">-->
// <!--                                <img src="./img/fifth-promo.png" alt="Second_img">-->
// <!--                            </div>-->
// <!--                        </div>-->
//                     </div>
//                 `;
...
//                     // info_booking_main.style.width = '900px'
